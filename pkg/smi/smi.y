 ...
 */
importIdentifier:	tOBJECT_IDENTIFIER
	|		importedKeyword
			{
				$$ = ""
			}
 ...
 */
fuzzy_lowercase_identifier:	tOBJECT_IDENTIFIER
			{
			}
	;
 ...
 */
sequenceItem:		tOBJECT_IDENTIFIER sequenceSyntax
			{
			}
	;
...
objectIdentityClause:	tOBJECT_IDENTIFIER
			tOBJECT_IDENTITY
			tSTATUS Status
			tDESCRIPTION Text
			ReferPart
...
objectTypeClause:	tOBJECT_IDENTIFIER
			tOBJECT_TYPE
...
Error:                  tOBJECT_IDENTIFIER '(' tNUMBER ')'
			{
			}
        ;
...
notificationTypeClause:	tOBJECT_IDENTIFIER
			tNOTIFICATION_TYPE
...
moduleIdentityClause:	tOBJECT_IDENTIFIER
			tMODULE_IDENTITY
...
CategoryID:		tOBJECT_IDENTIFIER
                        {
                        }
        |               tOBJECT_IDENTIFIER '(' tNUMBER ')'
			{
			}
        ;
...
SimpleSyntax:		tINTEGER			/* (-2147483648..2147483647) */
	...
	|		moduleName '.' tOBJECT_IDENTIFIER enumSpec
			{
			}
	|		tOBJECT_IDENTIFIER integerSubType
			{
			}
	|		moduleName '.' tOBJECT_IDENTIFIER integerSubType
			{
			}
	...
	|		tOBJECT_IDENTIFIER octetStringSubType
			{
			}
	|		moduleName '.' tOBJECT_IDENTIFIER octetStringSubType
			{
			}
...
valueofSimpleSyntax:	tNUMBER			/* 0..2147483647 */
	...
	|		tOBJECT_IDENTIFIER	/* enumeration or named oid */
			{
			}
...
Status:			tOBJECT_IDENTIFIER
			{
			}
        ;

Status_Capabilities:	tOBJECT_IDENTIFIER
			{
			}
        ;
...
subidentifier_defval:	tOBJECT_IDENTIFIER '(' tNUMBER ')'
			{}
	|		tNUMBER
			{}
	;

objectGroupClause:	tOBJECT_IDENTIFIER
			{
			}
			tOBJECT_GROUP
			{
...
notificationGroupClause: tOBJECT_IDENTIFIER
			{
			}
			tNOTIFICATION_GROUP
			{
...
moduleComplianceClause:	tOBJECT_IDENTIFIER
			{
			}
			tMODULE_COMPLIANCE
			{
...
ComplianceModuleName:	tOBJECT_IDENTIFIER objectIdentifier
			{
			}
	|		tOBJECT_IDENTIFIER
			{
...
agentCapabilitiesClause: tOBJECT_IDENTIFIER
			{
			}
			tAGENT_CAPABILITIES
			{
...
ModuleName_Capabilities: tOBJECT_IDENTIFIER objectIdentifier
			{
			}
	|		tOBJECT_IDENTIFIER
			{
...
VariationAccess:	tOBJECT_IDENTIFIER
			{
			}
        ;
